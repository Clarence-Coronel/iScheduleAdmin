<?php
    ...
    if(!isFull($object->scheduleDate, $object->timeSlot, getMax($object->timeSlot))){
        $query = "INSERT INTO `appointments`(`departmentID`, `firstName`, `middleName`, `lastName`, `sex`, `birthdate`, `phone`, `province`, `municipality`, `barangay`, `patientType`, `appointmentType`, `scheduleID`, `appointmentDate`, `caseNo`, `appointmentStatus`, `consultation`, `isFollowUp`) VALUES ('$object->department', '$object->firstName', '$object->middleName', '$object->lastName', '$object->sex', '$object->dateOfBirth', '$object->phone', '$object->province', '$object->municipality', '$object->barangay', '$object->typeOfPatient', 'admin website', '$object->timeSlot', '$object->scheduleDate', '$object->caseNo', 'scheduled', '$object->consultation', '$object->isFollowUp')";
